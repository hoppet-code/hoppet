...
int main()
{
  ...
  // select desired coefficient
  auto& coeff_as3 = ome::AqqQNSEven_reg[3];
  auto& coeff_as3_LM0 = coeff_as3[0];
  auto& coeff_as3_LM0_NF1 = coeff_as3_LM0[1];
  ...
  for(int i = 0; i < n_steps; ++i)
  {
    ...
    std::cout << std::setprecision(15) << std::left
              << std::setw(25) << x
              << std::setw(25) << coeff_as3_LM0_NF1(x)
              << std::endl;
  }
