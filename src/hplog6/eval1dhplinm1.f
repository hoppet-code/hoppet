      subroutine eval1dhplinm1(y,nw,H1,H2,H3,H4,H5,H6, 
...
** evaluate H(...,-y) 
      ...
      Gi1(0) = -1
      call eval1dhplin1(-y,nw,G1,G2,G3,G4,G5,G6, 
...
** correct the ill-defined entries
     ...
     $                  + HY5(0,0,0,0,-1)
      ...
      if ( nw.eq.5 ) return
      HY6(-1,0,0,0,0,0) = -HY4(0,0,0,0)*HY2(0,-1)-HY2(0,0)*HY4(0,0,0,-1)
     $                  - HY6(0,0,0,0,0,-1)
      Hi6(-1,0,0,0,0,0) = +HY1(-1)*Hi5(0,0,0,0,0)
     $                    +HY3(0,0,-1)*Hi3(0,0,0)+HY5(0,0,0,0,-1)*Hi1(0)
