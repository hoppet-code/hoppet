...
module dglap_holders
  ...
  type dglap_holder
     ...
     !----------------------------------  nloop,nf_heavy
     type(new_mass_threshold_mat), pointer :: allMTM(:,:) => null()
     type(new_mass_threshold_mat), pointer :: MTM2 ! legacy, deprecated, pointer to MTM(3,nf)
     type(new_mass_threshold_mat), pointer :: MTM_NNLO, MTM_N3LO ! will be pointers to MTM(3,nf) and MTM(4,nf)
