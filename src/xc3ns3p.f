...
*
     ...
     $      536.D0/405.D0* DL**5 - 4036.D0*D81* DL**4 - 496.95D0 * DL
     $      **3 - 1488.D0 * DL**2 - 293.3D0 * DL - 512.D0*D27 * DL1**5 +
     ...
     $      + 310.4D0 * Y) + 304.D0*D81 * DL**4 + 48512.D0/729.D0 * DL
     $      **3 + 305.32D0 * DL**2 + 366.9D0 * DL - 1.200D0 * Y*DL**4 -
     $      640.D0*D81 * DL1**4 + 32576.D0/243.D0* DL1**3 - 660.7D0 *
     $      DL1**2 + 959.1D0 * DL1 + 31.95D0 * (1.D0-Y)*DL1**4 + DL*DL1
     $      * (1496.D0 + 270.1D0 * DL - 1191.D0* DL1) ) + NF**2 * (
     $      11.32D0 + 51.94D0 * Y - Y*Y1* (44.52D0 + 11.05D0 * Y) -
     $      368.D0* D243* DL**3 - 2848.D0*D243* DL**2 - 16.00D0 * DL -
     $      64.D0*D81* DL1**3 + 992.D0*D81* DL1**2 - 49.65D0 * DL1 -
     $      DL*DL1 * ( 39.99D0 + 5.103D0 * DL - 16.30D0 * DL1) +
     $      0.0647D0 * Y*DL**4 ) + FL02*NF * ( 48.79D0 - (242.4D0 -
     $      150.7D0 * Y ) * Y1 - 16.D0*D27 * DL**5 + 17.26D0* DL**3 -
     $      113.4D0 * DL**2 - 477.0D0 * DL + 2.147D0 * DL1**2 - 24.57D0
     $      * DL1 + Y*DL * (218.1D0 + 82.27D0 * DL**2) - DL*DL1 *
     $      (81.70D0 + 9.412D0 * DL1) ) * Y1
*
       RETURN
       END FUNCTION
*
