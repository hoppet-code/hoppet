...
c     ,        + FL11*NF * ( ( 126.42 - 50.29 * Y - 50.15 * Y**2) * Y1 
c     ,           - 26.717 - 960.*D243 * DL**2 * (DL+5.D0) + 59.59 * DL
c     ,           - Y*DL**2 * (101.8 + 34.79 * DL + 3.070 * DL**2)
c     ,           - 9.075 * Y*Y1*DL1 ) * Y
       ELSE
       C2NP3A = FL11*NF * ( ( 126.42 - 50.29 * Y - 50.15 * Y**2) * Y1 
