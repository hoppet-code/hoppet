...
\item \ttt{n3lo\_nfthreshold\_exact\_fortran}: all contributions are
  ...
  Eq.~(\ref{eq:hp-nf1}), which is based on piecewise expansions, and
  the \ttt{NShV} term, which is available with
  Ref.~\cite{Behring:2025avs} but, as of v2.2.0, has yet to be
  incorporated in \hoppet and is instead set to zero.
  %
