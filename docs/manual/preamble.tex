...
% fontenc is needed to ensure that underscores can be copy/pasted
% from the PDF
\usepackage[T1]{fontenc}
% chatgpt recommends using this as well
\usepackage{lmodern}
...
%% BEWARE: repolink gets modified by scripts/set-version.sh (set to master on
%% a development or pre-release version, specific tag corresponding to
%% the the hoppet-x.y.z tag otherwise
%\newcommand{\repolink}[2]{\href{https://github.com/hoppet-code/hoppet/blob/master/#1}{\ttt{#2}}}
\newcommand{\repolink}[2]{\href{https://github.com/hoppet-code/hoppet/blob/hoppet-2.2.0/#1}{\ttt{#2}}}
%%
