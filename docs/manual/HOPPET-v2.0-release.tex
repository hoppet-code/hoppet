...
codes.\footnote{Other codes such as ChiliPDF~\cite{Diehl:2021gvs}
...
but also of low-level functionality though a stable, public API, has led to it being used for a range of
...
%
As of v2.1, that interface is accessible only in modern Fortran,
