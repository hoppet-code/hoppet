...
multiple nested, each uniform in $y= \ln 1/x$, with the nesting
...
polynomials are evaluated using adaptive Gaussian integration.
%
...
Table~\ref{tab:streamlined-interface}. \gps{Include QED?}
...
though some parts of it are being extended it to other languages.
