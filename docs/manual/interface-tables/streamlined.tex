...
%%--------------------------------------------------------
 \toprule
\tabsecheader{Configuration} \\\midrule
%--------------------------------------------------------
\begin{lstlisting}
...
Sets use of exact NNLO mass thresholds and splitting functions
  (default: both false., i.e.\ parametrised).
  \\\hline
\begin{lstlisting}
...
&\fn
  ...
  thresholds, cf.\ Sec.~\ref{sec:n3lo-evolution}, Tab.\comment{TABNUMBER}
\\\hline
% 
\begin{lstlisting}
