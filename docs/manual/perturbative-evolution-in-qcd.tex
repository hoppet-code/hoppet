...
\hoppet are defined to be coefficients of powers of $\as/2\pi$, but
...
\end{align}
for the light flavours and the gluon, where $A_{i\le n_\ell}$ has the
same flavour structure as an $n_\ell$-flavour splitting matrix, cf.\
Eq.~(\ref{eq:P-flavour-basis}).
%
...
%
Similarly, from at NNLO onwards, the heavy-quark PDFs start from a
