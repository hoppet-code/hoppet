...
\gps{carrying out the matching at a scale equal to the heavy-quark mass}
...
Ref.~\cite{BlumleinCode} with us, which \gps{also} contains code found
in \gps{associated with?}
Refs.~\cite{Ablinger:2024xtt,Fael:2022miw}.
%
\gps{Is there a reason why \cite{Fael:2022miw} is not in the main
  list? And maybe also \cite{BlumleinCode}?}.
}
%
...
the coefficient functions \gps{in VFN schemes} resulting in continuous physical
