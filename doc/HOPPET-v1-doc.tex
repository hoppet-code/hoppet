...
the vanilla interface of section~\ref{sec:vanilla}, is to be found as
...
program tabulation_example
  ...
  ! some cleaning up (not strictly speaking needed, but illustratative)
...
threshold terms.
%
The reader may verify that theey correspond to those given in the top
