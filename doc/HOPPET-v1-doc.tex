...
from {\tt \CPP{}} --- the interface is essentially identical to the Fortran
...
Note that in contrast to \ttt{C}/\ttt{\CPP{}} pointers, F95 pointers do
not explicitly need to be dereferenced --- in this respect they are
more like \ttt{\CPP{}} \emph{references}. To associate a pointer with an
