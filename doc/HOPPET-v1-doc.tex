...
It initialises the parameters relevant to the QED coupling
...
%
\commentpn{It is unclear to us how crossing the flavour threshold in
...
Next one neeeds to prepare a \ttt{pdf\_table} object forming the
