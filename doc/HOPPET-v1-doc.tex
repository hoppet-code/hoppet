...
apprpriate. \comment{AK: I wonder if it isn't worth adding the
  \ttt{read\_PDF} subroutine from the example to the structure
  function module such that when one starts/initialises the structure
  functions one also sets up these two mandatory bits.} With the PDF
