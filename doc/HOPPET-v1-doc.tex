...
The \ttt{use_qed} argument turns on/off QED evolution at order ${\cal O}(\alpha)$
(i.e. items 1. and 2. in Sec.~\ref{sec:qed-evolution}). The \ttt{use_qcd_qed} one
turns on/off mixed QCD$\times$QED effects in the evolution (i.e. item
3. in Sec.~\ref{sec:qed-evolution}) and \ttt{use_Plq_nnlo} turns on/off the
