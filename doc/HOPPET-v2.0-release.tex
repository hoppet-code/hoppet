...
in modern Fortran,\footnote{This release of \hoppet makes use of
  ...
  needed.}  with interfaces also for C/\CPP{} and earlier dialects of
Fortran.
%
...
evolution codes has evolved substantially, with a range of new-source
codes having been developed, for example the APFEL, APFEL++ and EKO
codes~\cite{}\gps{find cites, expand list?} (the latter including
...
Note that for this 2.0.0, release \hoppet's library name has been renamed
...
that they link with the new library.
}}
...
\comment{Add Melissa for work on speed-up}
