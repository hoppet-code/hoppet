...
%\newcommand{\repolink}[2]{\href{https://github.com/gavinsalam/hoppet/blob/master/#1}{\ttt{#2}}}
...
\newcommand{\commentpn}[1]{{\color{darkgreen} [\bf PN:  #1}]$_\text{PN}$}
...
\begin{abstract}
  ...
  structure functions. \gps{Do we add some details. E.g. structure
    functions up to N$^3$LO and some suitable statement for QED?}
\end{abstract}
...
lower-level functionality \commentpn{I would say functionalities (but let Gavin decide...} for operations such as convolutions of
