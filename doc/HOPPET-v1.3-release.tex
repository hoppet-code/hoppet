...
\begin{abstract}
  We document the three main new features in release 1.3.0 of the
  ...
  equivalent to NNLO QCD, for N$^3$LO QCD evolution in the
  variable flavour number scheme, and for the determination of
  hadronic structure functions for massless quarks up to N$^3$LO.
\end{abstract}
...
introduced in Fortran~2003, in particular the use of \ttt{abstract
