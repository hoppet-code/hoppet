...
prefix. The interface is installed automatically as \ttt{hoppet}
with \ttt{Cmake} and can be used through \ttt{import hoppet}. For a
...
write a file \ttt{basename.info} again in the LHAPDF format. For any
other value of \ttt{pdf\_index} only the corresponding \ttt{.dat} file
will be written.
