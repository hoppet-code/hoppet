...
$2 < Q < 10^4\, \text{GeV}$.\footnote{For tabulations extending to
  significantly smaller $x$ values, it may be advantageous to take a
...
parton distribution functions because a very steep function of $\ln
x$.
%
...
reaches as little as $1\,\mathrm{ms}$ for \texttt{dy = 0.2}.
%
...
factor 10, which we attribute mainly to improvements in the hardware.
