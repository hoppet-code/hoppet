...
made.
%
This is now to the extent that two PDF groups have released fits at
...
can be reliably
determined~\cite{McGowan:2022nag,NNPDF:2024nan,Moch:2021qrk,Falcioni:2023luc,Falcioni:2023vqq,Moch:2023tdj,Falcioni:2024xyt}.
%
...
Refs.~\cite{Davies:2016jie,Moch:2017uml,Falcioni:2023luc,Falcioni:2023vqq,Moch:2023tdj,Falcioni:2024xyt} (FHMPRUVV),
...
%
The approximate splitting functions can either return three different
values corresponding to an upper and a lower band and their
average.
%
...
the FHMPRUVV group. At the time of writing it takes two values: the
slightly older implementation
...
and \ttt{n3lo\_splitting\_approximation\_up\_to\_2404\_09701} meaning
the approximations in papers up to and including
...
them out are described in detail in Ref.~\cite{Bertone:2024dpm}. A simplified version of that benchmark can be found in
