...
writing of \ttt{n3lo\_splitting\_approximation\_up\_to\_2410\_08089}
...
\begin{figure}[p]
  ...
  \begin{subfigure}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,page=1]{figs-v2/n3lo_k_factors.pdf}
    \caption{}
    \label{fig:n3lok-benchmark-mtm}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,page=2]{figs-v2/n3lo_k_factors.pdf}
    \caption{}
    \label{fig:n3lok-benchmark-nomtm}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,page=3]{figs-v2/n3lo_k_factors.pdf}
    \caption{}
    \label{fig:n3lok-nnpdf40-mtm}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,page=4]{figs-v2/n3lo_k_factors.pdf}
    \caption{}
...
%
Let us first focus on Fig.~\ref{fig:n3lok-benchmark-mtm}.
%
It starts with the benchmark initial condition at the standard low
scale of $Q_0 = \sqrt{2}\GeV$, just below the charm mass.
%
It then evolves the PDF with \ntlo and NNLO evolution, and shows the
...
work, but for illustrative purposes we present an update of Fig. 3
using the full \ntlo evolution in Fig~\ref{fig:perturbativeconvergence}.
%
\begin{figure}[tb!]
...
\end{figure}
%
That figure shows the $F_2^{\rm NC}$ structure function at various
...
to \ntlo. As can be seen by comparing to the original figures, the
\ntlo evolution has the effect at low $Q$ of increasing $F_2^{\rm NC}$
...
The user can now globally override any table-specific interpolation order
