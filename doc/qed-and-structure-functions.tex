...
For user-cases where PDF evaluation speed is critical, one option is
read in a PDF grid with LHAPDF, evaluate it at all \hoppet grid points and
...
\begin{table}[htbp]
  ...
  \ttt{hoppetEval} with all flavours, considering different
  ...
  Python 3.12.7. \\
  %
  $^\dagger$\ Note that in its Fortran and Python interfaces, this version of
