...
$10^{-5}$ &  $2.8946^{-3}$ &  $1.6810^{-3}$ &  $1.2302^{-4}$ &  $3.4056^{+1}$ &  $-3.5766^{-6}$ &   $1.6352^{+1}$ &  $1.5902^{+1}$ &  $2.2426^{+2}$ \\
...
$0.9$    &  $3.5128^{-4}$ &  $1.7793^{-5}$ &  $8.6472^{-9}$ &  $2.6376^{-8}$ &  $-1.5848^{-10}$ &  $6.8210^{-9}$ &  $2.6764^{-9}$ &  $1.2256^{-6}$ 
  ...
  \caption{N$^3$LO evolution of the initial condition given in Section
    ...
    facilitate comparisons by other groups, and the N3LO splitting
    functions use the
    \ttt{n3lo\_splitting\_approximation = n3lo\_splitting\_approximation\_up\_to\_2404\_09701} choice. This table can be directly compared to tables 1 and 2 in Ref.~\cite{Cooper-Sarkar:2024crx}}
