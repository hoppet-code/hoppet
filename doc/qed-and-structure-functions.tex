...
\gps{Giulia had found a ref that gave a nice explanation, maybe we can
  add that ref here?}
\commentpn{What about: In fact, at that order, there are graphs with three vertices on the quark line and three vertices on the lepton line, that change sign if the lepton line is charge-conjugated.}
%
