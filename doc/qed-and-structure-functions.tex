...
%
Using a value of $0.109\GeV$ generates QED coupling values at the
masses of the $\tau$ lepton ($1/133.458$) and $Z$-boson ($1/127.952$)
that agree to within relative $\sim 2\times 10^{-4}$ accuracy with the
$\MSbar$ values ($1/(133.450 \pm 0.006)$ and $1/(127.930 \pm 0.008)$)
from the ``Electroweak and constraints on New Physics'' section of the
2024 Particle Data Group review~\cite{}.\comment{Add ref, decide about
  updating in qed\_coupling.f90 to 2024, and also the ref above}
