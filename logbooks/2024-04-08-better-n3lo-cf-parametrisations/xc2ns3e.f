...
!     HR1(0) nonzero at x->1
!       if(x.gt.0.99999d0) print*, x, HR2
*
...
* ...For 5-digit accuracy down to x=0.9
     $         + (1.-x)**2 * (-0.5*DL1-0.25*z2-0.5*z3+5./8.d0)
       endif
*
      SP2 =
     ...
     $         + (1.-x)**2 * (-0.5)
*     ...For 5-digit accuracy down to x=0.9
     $         + (1.-x)**3 * (DL1/3.d0+z2/18.d0+z3/3.d0-0.75)
     $         + (1.-x)**4 * (DL1/3.d0+z2/18.d0+z3/3.d0-0.5)
     $         + (1.-x)**5 * (31./120.d0*DL1+17./360.d0*z2+7./30.d0*z3
     $         -1103./4800.d0)
       endif
*
