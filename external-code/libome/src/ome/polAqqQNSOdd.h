...
#ifndef LIBOME_POLAQQQNSODD_H
#define LIBOME_POLAQQQNSODD_H
...
namespace ome
{
   ...
   * \addtogroup ome-data
   * \{
   * \defgroup ome-data-polAqqQNSOdd polAqqQNSOdd
   * \brief Data objects for \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
   * \{
   */
  /// Regular part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as<double> polAqqQNSOdd_reg;

  /// Plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as_plus<double> polAqqQNSOdd_plus;

  /// Delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as_const<double> polAqqQNSOdd_delta;

  /// Container for regular, plus and delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
  extern const rpd_distribution<ome_as_view<double>, ome_as_plus_view<double>, ome_as_const_view<double>> polAqqQNSOdd;
 ...
 * \{
 * \defgroup c-interface-polAqqQNSOdd polAqqQNSOdd
...
double ome_polAqqQNSOdd_reg(double as, double LM, double NF, double x);
/// Evaluate regular part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_polAqqQNSOdd_reg_trunc_as(int trunc_order, double as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$ coefficient of the regular part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_reg_coeff_as(int order_as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the regular part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_reg_coeff_as_LM(int order_as, int order_LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the regular part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_reg_coeff_as_LM_NF(int order_as, int order_LM, int order_NF, double x);

/// Evaluate plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_plus(double as, double LM, double NF, double x);
/// Evaluate plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_polAqqQNSOdd_plus_trunc_as(int trunc_order, double as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$ coefficient of the plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_plus_coeff_as(int order_as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_plus_coeff_as_LM(int order_as, int order_LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the plus part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_plus_coeff_as_LM_NF(int order_as, int order_LM, int order_NF, double x);

/// Evaluate delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_delta(double as, double LM, double NF);
/// Evaluate delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_polAqqQNSOdd_delta_trunc_as(int trunc_order, double as, double LM, double NF);
/// Evaluate a given \f$a_s\f$ coefficient of the delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_delta_coeff_as(int order_as, double LM, double NF);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_delta_coeff_as_LM(int order_as, int order_LM, double NF);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the delta part of \f$\Delta A_{qq,Q}^{\text{NS},-}\f$
double ome_polAqqQNSOdd_delta_coeff_as_LM_NF(int order_as, int order_LM, int order_NF);
