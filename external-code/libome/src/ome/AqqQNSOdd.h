...
#ifndef LIBOME_AQQQNSODD_H
#define LIBOME_AQQQNSODD_H
...
namespace ome
{
   ...
   * \addtogroup ome-data
   * \{
   * \defgroup ome-data-AqqQNSOdd AqqQNSOdd
   * \brief Data objects for \f$A_{qq,Q}^{\text{NS},-}\f$
   * \{
   */
  /// Regular part of \f$A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as<double> AqqQNSOdd_reg;

  /// Plus part of \f$A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as_plus<double> AqqQNSOdd_plus;

  /// Delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
  extern const ome_as_const<double> AqqQNSOdd_delta;

  /// Container for regular, plus and delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
  extern const rpd_distribution<ome_as_view<double>, ome_as_plus_view<double>, ome_as_const_view<double>> AqqQNSOdd;
 ...
 * \{
 * \defgroup c-interface-AqqQNSOdd AqqQNSOdd
...
double ome_AqqQNSOdd_reg(double as, double LM, double NF, double x);
/// Evaluate regular part of \f$A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_AqqQNSOdd_reg_trunc_as(int trunc_order, double as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$ coefficient of the regular part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_reg_coeff_as(int order_as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the regular part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_reg_coeff_as_LM(int order_as, int order_LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the regular part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_reg_coeff_as_LM_NF(int order_as, int order_LM, int order_NF, double x);

/// Evaluate plus part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_plus(double as, double LM, double NF, double x);
/// Evaluate plus part of \f$A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_AqqQNSOdd_plus_trunc_as(int trunc_order, double as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$ coefficient of the plus part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_plus_coeff_as(int order_as, double LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the plus part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_plus_coeff_as_LM(int order_as, int order_LM, double NF, double x);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the plus part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_plus_coeff_as_LM_NF(int order_as, int order_LM, int order_NF, double x);

/// Evaluate delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_delta(double as, double LM, double NF);
/// Evaluate delta part of \f$A_{qq,Q}^{\text{NS},-}\f$ truncated in \f$a_s\f$
double ome_AqqQNSOdd_delta_trunc_as(int trunc_order, double as, double LM, double NF);
/// Evaluate a given \f$a_s\f$ coefficient of the delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_delta_coeff_as(int order_as, double LM, double NF);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$ coefficient of the delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_delta_coeff_as_LM(int order_as, int order_LM, double NF);
/// Evaluate a given \f$a_s\f$, \f$L_M\f$, \f$N_F\f$ coefficient of the delta part of \f$A_{qq,Q}^{\text{NS},-}\f$
double ome_AqqQNSOdd_delta_coeff_as_LM_NF(int order_as, int order_LM, int order_NF);
