...
set output 'param_vs_exact_structure_functions_Q2GeV.pdf'
set macros
...
exact='exact_structure_functions_full_exact_tiny_1d-10_Q2GeV.dat'
param='param_structure_functions_Q2GeV.dat'
...
set title 'Q = 2 GeV, LO+NLO+NNLO+N3LO, W^+'
set ylabel 'param/exact'
set xlabel 'x'
...
set title 'Q = 2 GeV, LO+NLO+NNLO+N3LO, Z'
set ylabel 'param/exact'
set xlabel 'x'
...
set title 'Q = 2 GeV, LO+NLO+NNLO, W^+'
set ylabel 'param/exact'
set xlabel 'x'
...
set title 'Q = 2 GeV, LO+NLO+NNLO, Z'
set ylabel 'param/exact'
set xlabel 'x'
